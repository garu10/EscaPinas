...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 08, 2026 at 02:46 PM
...
INSERT INTO `users` (`user_id`, `first_name`, `last_name`, `middle_initial`, `contact_num`, `region`, `province`, `city`, `email`, `password`, `role`, `is_verified`, `verification_code`, `otp_expiry`) VALUES
(1, 'Jhon', 'Mackay', 'S', '09995635443', NULL, 'Batangas', 'Tanauan CIty', 'mackayjhondrei632@gmail.com', '$2y$10$ig78VJKaY6kVmJlvP9iG3ep3zHQbq3eOxedqWOUqBrASURIMQloFS', 'user', 1, NULL, NULL),
(2, 'Joyce Anne', 'Remo', 'P', '09912676928', NULL, 'Batangas', 'City', 'joyceanneremo05@gmail.com', '$2y$10$NNArr6zfvMjbHIlTQ5b9F.i7aQAQGFJ6VuJtE2rEK4upDlqknFFdG', 'user', 1, NULL, NULL),
...
(33, 'Lee Seokmin', 'Salvador', 'S', '09912676928', NULL, 'Batangas', 'City', 'amucasconstruction3@gmail.com', '$2y$10$6oHqQJejclxtLiz8jX0kE.vvteEZHsb2reS/EQ24hb/Luabd6c5Sq', 'user', 1, NULL, NULL),
(34, 'Jhon Drei', 'Mackay', 'S', '09995635443', NULL, 'Batangas', 'Tanauan CIty', 'jhondrei062@gmail.com', '$2y$10$VNG5qpJCpO7CBIe4V7cqdeJwPL7gcXUIiAWJfwvPO0GUjrAThDN7i', 'user', 1, '848300', '2026-01-08 19:34:54');
...
INSERT INTO `user_vouchers` (`claim_id`, `user_id`, `template_id`, `is_redeemed`, `claimed_at`, `redeemed_at`) VALUES
(1, 34, 1, 1, '2026-01-08 20:22:08', NULL),
(2, 34, 2, 1, '2026-01-08 20:37:33', '2026-01-08 20:38:21'),
(3, 34, 4, 0, '2026-01-08 21:09:18', NULL),
(4, 34, 6, 0, '2026-01-08 21:39:11', NULL);
...
INSERT INTO `voucher_templates` (`template_id`, `System_type`, `code`, `title`, `discount_type`, `discount_amount`, `min_order_amount`, `expires_at`, `created_at`) VALUES
(1, 'travel_agency', 'test1', 'Test usage of vouchers', 'fixed', 1000.00, 0.00, '2026-01-16 20:00:00', '2026-01-08 20:06:16'),
(2, 'travel_agency', 'TEST2', 'This is a test voucher', 'fixed', 1200.00, 0.00, '2026-01-15 23:59:59', '2026-01-08 20:37:25'),
(3, 'ebook_store', 'TEST3', 'test 3 of voucher', 'fixed', 2000.00, 0.00, '2026-01-08 13:46:41', '2026-01-08 20:47:02'),
(4, 'ebook_store', 'TEST4', 'this is test 4', 'fixed', 2000.00, 0.00, '2026-01-16 20:56:29', '2026-01-08 20:56:56'),
(5, 'travel_agency', 'TEST5', 'This is test 5', 'fixed', 3000.00, 0.00, '2026-01-15 14:14:47', '2026-01-08 21:15:13'),
(6, 'ebook_store', 'qwert', 'qaveveva', 'fixed', 1000.00, 0.00, '2026-01-15 14:27:44', '2026-01-08 21:27:58');
...
ALTER TABLE `user_vouchers`
  ...
  ADD UNIQUE KEY `unique_user_voucher` (`user_id`,`template_id`),
...
--
ALTER TABLE `user_vouchers`
  ADD CONSTRAINT `fk_template_id` FOREIGN KEY (`template_id`) REFERENCES `voucher_templates` (`template_id`) ON DELETE CASCADE,
