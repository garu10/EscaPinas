...
--
-- Host: localhost
-- Generation Time: Jan 13, 2026 at 06:08 PM
...
(61, 47, 2, 1, 12093.76, 'Cancelled', 'ESC-2026-DBB24A', 1, 8, 1),
(62, 47, 1, 1, 12093.76, 'Cancelled', 'ESC-2026-8A61B6', 1, 7, 1);
...
(47, 61, 47, '09Y90363CJ785433D', '82C22034N6220642G', 12093.76, 'PHP', 'REFUNDED', '2026-01-13 13:41:49'),
(48, 62, 47, '69K68813FV078011Y', '8MC22357LL913912W', 12093.76, 'PHP', 'REFUNDED', '2026-01-13 16:43:20');
...
--
-- Table structure for table `refund_wallet`
--

CREATE TABLE `refund_wallet` (
  `wallet_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `amount` decimal(10,2) NOT NULL DEFAULT 0.00,
  `type` enum('Refund','Payment','Adjustment') NOT NULL DEFAULT 'Refund',
...
--
-- Dumping data for table `refund_wallet`
--

INSERT INTO `refund_wallet` (`wallet_id`, `user_id`, `amount`, `type`, `description`, `running_balance`, `updated_at`) VALUES
(1, 47, 0.00, 'Refund', NULL, 12093.76, '2026-01-13 16:52:35'),
(2, 47, 12093.76, 'Refund', 'Refund for Booking #61', 24187.52, '2026-01-13 17:05:40');
...
(22, 47, '09666935239', 'Review', 'Thank you for booking with EscaPinas! We value your experience and would love your feedback. Reply to this message to share your thoughts. Ref: ESC-2026-8A61B6', 'failed', '36FpVUC4O1_aNKGDIsLrT', '2026-01-13 16:43:27');
...
(47, 'test', 'Ralphh', 'Alcantara', 'M', '09666935239', NULL, 'Batangas', 'Tanauan', 'alcantarajohnralph@gmail.com', '$2y$10$K3OuXIE5but1smYldw0ZCewkWqQhUttl/kspZVSPo745M/Abofsv.', 'user', 1, NULL, NULL),
...
--
-- Indexes for table `refund_wallet`
--
ALTER TABLE `refund_wallet`
...
--
-- AUTO_INCREMENT for table `refund_wallet`
--
ALTER TABLE `refund_wallet`
