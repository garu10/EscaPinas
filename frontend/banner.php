...
<body>
    ...
    <div class="row g-0">
        <div class="col-12">
        <div class="front-banner d-flex align-items-center">

            <div class="front-overlay"></div>
            <div class="container position-relative text-center text-md-start">
            <h1 class="front-title">Magandang Araw!</h1>
            <p class="front-subtitle">
                Explore beautiful places in the Philippines with EscaPinas
            </p>

            <div class="search-box mt-4">
                <div class="row g-2 align-items-center">
                <div class="col-12 col-md-3">
                    <input type="text" class="form-control" placeholder="Places to go">
                </div>
                ...
                <select class="form-select">
                    <option selected disabled>Days & Nights</option>
