<div class="container my-5">
  ...
  <div class="row g-4 text-center">
    <div class="col-lg-3 col-md-6 col-sm-12">
      <div class="border rounded-3 border-success p-3 h-100">
  ...
  <div class="row align-items-center g-4">
    ...
    <div class="col-md-6 text-center text-md-start">
      ...
      <div class="d-flex gap-3 justify-content-center justify-content-md-start mt-3">
        <img src="/EscaPinas/frontend/assets/images/paypal.png" class="img-fluid" style="height:45px;">
        <img src="/EscaPinas/frontend/assets/images/mastercard.webp" class="img-fluid" style="height:45px;">
      </div>
    </div>
    
    <div class="col-md-6 text-center">
      <img src="/EscaPinas/frontend/assets/images/banner_about.jpg" 
          class="img-fluid rounded shadow-lg border border-2"
