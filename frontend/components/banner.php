...
<body>
    ...
    <div class="row g-0 h-50 align-items-start justify-content-center banner-content">
        ...
        <div class="card border-0 p-3 search-card">
            ...
            <form action="search.php" method="GET" class="row g-2 align-items-center">
                ...
                <div class="col-md-3">
                <label class="small fw-bold mb-1 d-block"><i class="fa-solid fa-users me-1"></i> Travelers</label>
