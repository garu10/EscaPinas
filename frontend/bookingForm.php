<?php
    ...
    if ($locpoints_id > 0) {
        $locResult = executeQuery("SELECT locpoints_id FROM location_points WHERE locpoints_id = $locpoints_id");
        if (! $locResult || $locResult->num_rows === 0) {
            echo json_encode(['success' => false, 'message' => 'Invalid pickup/dropoff selection']);
            exit;
        }
    }
?>
    ...
    <div class="container my-5">
        ...
        <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="h4 fw-bold mb-2 text-dark">
                        <?php echo $tour['tour_name']; ?>
                    </div>
                    <div class="row mb-3 text-muted small">
                        <div class="col"><i class="fas fa-map-marker-alt text-danger me-1"></i>
                            <?php echo $tour['destination_name']; ?>,
                            <?php echo $tour['island_name']; ?>
                        </div>
                        <div class="col"><i class="far fa-clock text-primary me-1"></i>
                            <?php echo $tour['duration_days']; ?>D /
                            <?php echo $tour['duration_nights']; ?>N
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="schedule_id" class="form-select form-select-sm w-50" form="bookingForm">
                            ...
                            <option value="<?php echo $s['schedule_id']; ?>">
                                ...
                                <?php echo date('M d, Y', strtotime($s['end_date'])); ?>
                            </option>
                            <?php endwhile; ?>
                        </select>
                    </div>
                    ...
                    <div class="small text-muted mb-3 border-start border-success border-3 ps-3">
                        ...
                        <div class="mb-1"><i class="fas fa-check text-success me-2 small"></i>
                    ...
                    <div class="d-flex align-items-center gap-4">
                        ...
                        <div class="bg-light rounded-pill px-3 py-2 d-flex align-items-center gap-3">
                            <a href="?tour_id=<?php echo $tour_id ?>&pax=<?php echo max(1, $pax - 1) ?>&client_region=<?php echo $client_region ?>&voucher=<?php echo $voucher_code ?>"
                                class="btn btn-sm btn-light rounded-circle fw-bold shadow-sm">-</a>
                            <span class="fw-bold px-2">
                                <?php echo $pax; ?>
                            </span>
                            <a href="?tour_id=<?php echo $tour_id ?>&pax=<?php echo $pax + 1 ?>&client_region=<?php echo $client_region ?>&voucher=<?php echo $voucher_code ?>"
                                class="btn btn-sm btn-light rounded-circle fw-bold shadow-sm">+</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm rounded-4 p-4 mb-4 bg-white">
                    <div class="row g-4">
                        ...
                        <div class="col-6">
                            ...
                            <span
                                class="badge                                                                                                                                       <?php echo $badge_class; ?> border fw-bold rounded-pill px-3 shadow-sm">
                                <i
                                    class="fas                                                                                                                                    <?php echo $icon; ?> me-1"></i>
                                <?php echo $status; ?>
                            </span>
                        </div>
                    </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex gap-4">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="client_region"
                                        value="<?php echo $reg ?>" <?php echo($client_region==$reg) ? 'checked' : '' ;
                                        ?>
                        ...
                        if ($airfare) {
                            ...
                            ?>
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="radio" name="locpoints_id"
                                        id="loc_<?php echo $loc['locpoints_id']; ?>"
                                        value="<?php echo $loc['locpoints_id']; ?>" required>
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" class="form-control"
                                    value="<?php echo $user['middle_initial'] ?? ''; ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-5">
                                ...
                                <input type="text" name="contact_no" class="form-control"
                                    value="<?php echo $user['contact_no'] ?? ''; ?>" readonly>
                            </div>
                        </div>
            ...
            <div class="col-md-5">
                ...
                <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
                    ...
                    <div class="d-flex justify-content-between mb-2 text-danger small">
                        ...
                        <span class="fw-bold">+ ₱
                            <?php echo number_format($airfare_fee, 2); ?>
                        </span>
                    </div>
                    <?php endif; ?>
                    ...
                    <form action="" method="GET" class="d-flex gap-2 mb-2">
                        ...
                        <input type="text" name="voucher" class="form-control form-control-sm" placeholder="Enter code"
                    ...
                    <div class="card border-0 shadow-none bg-light p-3 text-center mb-4 rounded-3">
                        <div class="small text-muted mb-2 text-uppercase fw-bold" style="letter-spacing:1px;">Secure
                            Payment</div>
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="tour_details.php?tour_id=<?php echo $tour_id ?>"
                            class="btn btn-outline-danger w-100 py-3 fw-bold rounded-3 shadow-sm border-2">
                            CANCEL BOOKING
                        </a>
                    </div>
                </div>
        ...
        <script
            src="https://www.paypal.com/sdk/js?client-id=AZXarGlWci9EF_NV33Uzb79jiNCHrRaA9WCLLFRpl0Tuzul7OIh5Pgc1Frl114bn2MNsUgR1kphO2D1z&currency=PHP"></script>
                            ...
                            .then(text => {
                                try {
                                    ...
                                    if (details.success) {
                                        ...
                                        alert('Booking Error: ' + (details.message || 'Error occurred.'));
                                    }
                                } catch (e) {
                                    console.error("Server Error:", text);
                                    alert("Fatal Error: Check your PHP capture file.");
                                }
                            });
                    }
