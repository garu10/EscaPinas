...
<head>
    ...
    <style>
        ...
        .tour-img { width: 100%; border-radius: 15px; object-fit: cover; }
    </style>
</head>
<body>
...
<div class="container my-5">
    ...
    <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
        <div class="row">
            <div class="col-md-4">
                <img src="<?php echo $tour['image'];?>" class="tour-img shadow-sm" style="height:auto; width:400px; ">
            </div>
            <div class="col-md-8">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select form-select-sm w-50">
                        <?php while ($s = $schedules->fetch_assoc()): ?>
                            <option><?php echo date('M d, Y', strtotime($s['start_date']));?> - <?php echo date('M d, Y', strtotime($s['end_date']));?></option>
                        <?php endwhile; ?>
                    </select>
                </div>
